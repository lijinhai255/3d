<template>
  <div id="bigScreen">
    ...
    <div class="main">
      <div class="left">
        <!-- <div class="cityEvent" v-for="item in props.dataInfo" :key="item.name">
          <h3>
            <span>{{ item.name }}</span>
          </h3>
          <h1>
        ...
        <div class="cityEvent">
          ...
          <h1 @click="toggleEvent(0)">
            <img src="../assets/bg/bar.svg" class="icon" />
            <span>设置热气球以横穿园区动画显示</span>
          </h1>
          <h1 @click="toggleEvent(1)">
            <img src="../assets/bg/bar.svg" class="icon" />
            <span>设置热气球以环绕园区动画显示</span>
          </h1>
        </div>
      </div>
      <div class="right">121212</div>
    </div>
  </div>
</template>
